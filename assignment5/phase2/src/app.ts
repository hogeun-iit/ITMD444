...
export async function buildApp() {
  ...
  await app.register(swagger, {
    openapi: {
      openapi: "3.1.0",
      info: {
        title: "TubeDeck — Phase 1–2 (REST)",
        description:
          "`backend-dev-api.md`: Phase 2 adds `/videos/{videoId}/pipeline`, `/users/{userId}/recommendations`, YouTube cache, captions, optional OpenAI digest.",
        version: "1.0.0",
      },
      tags: [
        ...
        { name: "pipeline", description: "Transcript / digest pipeline status" },
        {
          ...
          description: "Queue-based resurfacing (saved videos only)",
        },
      ],
    },
  });
